...
//   };
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 " >
      <div className="h-auto w-auto lg:w-[800px] p-6 bg-slate-300 rounded-lg shadow-lg bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 ">
        <h1 className="text-center text-[25px] font-bold mb-6"> Add Doctors</h1>
        <form className="space-y-4 shadow-lg px-1">
          ...
          <label className="flex mb-1">
            ...
            <div className=" bg-gray-200 cursor-pointer relative w-16 h-8 rounded-full ml-2">
              <input
                ...
                onChange={handleAvailabilityClick}
              />
